...
Asset::set($url . '/' . Extend::state('panel', 'path') . '/::g::/-/c-k-editor.js', 10.1, [
    'src' => function($src) use($config, $t, $token) {
        ...
        return candy($this->url, [$src, abs(crc32($t . $token . $config->language))]);
    }
]);